	...
	public static class AttributeHelper
	{
			...
			Expression<Func<TAttribute, TExpected>> attributeSelector)
		{
			...
			if (memberExpression == null)
				throw new ArgumentException("Please supply expression to field/property", nameof(attributeSelector));
		...
		public static TExpected[] MemberAttribute<TAttribute, TExpected>(this Type classType, string memberName,
			Expression<Func<TAttribute, TExpected>> attributeSelector)
		{
			if (classType == null) throw new ArgumentNullException(nameof(classType));
			...
			if (attributeExpression == null)
				throw new ArgumentException("Please supply expression to field/property of attribute member",
					nameof(attributeExpression));
		...
		/// <param name="attributeSelector">Select member of <typeparamref name="TAttribute" /></param>
		/// <returns>The attribute's value from class member</returns>
		public static TExpected[] Member<TClass, TAttribute, TExpected>(string memberName,
			Expression<Func<TAttribute, TExpected>> attributeSelector)
			...
			Expression<Func<TAttribute, TExpected>> attributeSelector)
		{
			...
			if (classExpression == null)
				throw new ArgumentException("Please supply expression to field/property of class member", nameof(memberSelector));
