...
namespace Mail.Library.Test.Configuration
{
	...
	class IniLineParserTest
	{
		...
		[TestCase("  [   section ]", "section", null, true, Category = "INILineParser", TestName = "Section_ContainingAndPreceededSpace")]
		...
		[TestCase("[section] ; additional comment", "section", "additional comment", true, Category = "INILineParser", TestName = "Section_ContainingComment")]
		...
		[TestCase("key_123 = whatever value is it ok whether to use number (ex: 123) or alpha", "key_123", "whatever value is it ok whether to use number (ex: 123) or alpha", null, true, Category = "INILineParser", TestName = "Pair_ComplexValue")]
		...
		[TestCase("  key = value", "key", "value", null, true, Category = "INILineParser", TestName = "Pair_ContainingAndPreceededSpace")]
		...
		[TestCase("key = value ; additional comment", "key", "value", "additional comment", true, Category = "INILineParser", TestName = "Pair_ContainingComment")]
		[TestCase("key \t= value ; additional comment", "key", "value", "additional comment", true, Category = "INILineParser", TestName = "Pair_ContainingWhitespaceAndComment")]
