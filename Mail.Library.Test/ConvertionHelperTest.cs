...
namespace Mail.Library.Test
{
    ...
    class ConvertionHelperTest
    {
        ...
        [TestCase("Two", ExpectedResult = Number.Two, Category = "Enumeration", TestName = "NonNullable_ByMemberNameCaseSensitive")]
        [TestCase("three", ExpectedResult = Number.Three, Category = "Enumeration", TestName = "NonNullable_ByMemberNameCaseInsensitive")]
        [TestCase(" four ", ExpectedResult = Number.Four, Category = "Enumeration", TestName = "NonNullable_ByMemberNameContainingSpace")]
        [TestCase("unknown", ExpectedResult = default(Number), Category = "Enumeration", TestName = "NonNullable_OutOfScope")]
        public Number EnumTest(string value)
        {
            return ConvertionHelper.To<Number>(value);
        }

        [Test]
        [TestCase("1", ExpectedResult = Number.One, Category = "Enumeration", TestName = "Nullable_ByValue")]
        [TestCase("Two", ExpectedResult = Number.Two, Category = "Enumeration", TestName = "Nullable_ByMemberNameCaseSensitive")]
        [TestCase("three", ExpectedResult = Number.Three, Category = "Enumeration", TestName = "Nullable_ByMemberNameCaseInsensitive")]
        [TestCase(" four ", ExpectedResult = Number.Four, Category = "Enumeration", TestName = "Nullable_ByMemberNameContainingSpace")]
        [TestCase("unknown", ExpectedResult = null, Category = "Enumeration", TestName = "Nullable_OutOfScope")]
        public Number? EnumNullableTest(string value)
        {
            return ConvertionHelper.To<Number?>(value);
        }
        ...
        public void UnSupportedTest()
        {
            ...
            Assert.That(() => ConvertionHelper.To<System.DateTime>("2015-11-10"), Throws.TypeOf<System.NotSupportedException>());
            Assert.That(() => ConvertionHelper.To<System.TimeSpan>("20:30"), Throws.TypeOf<System.NotSupportedException>());
        }
